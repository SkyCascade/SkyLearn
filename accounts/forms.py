...
# Self-Registration Form (password auto-generated and sent via email)
class LearnerSelfRegistrationForm(forms.ModelForm):
    username = forms.CharField(
        max_length=30,
        widget=forms.TextInput(
            attrs={"type": "text", "class": "form-control", "id": "username_id"}
        ...
        label="Username",
        help_text="Choose a username you'll remember. This will be your login ID.",
    )
    ...
    def save(self, commit=True):
        ...
        user.phone = self.cleaned_data.get("phone")
        user.gender = self.cleaned_data.get("gender")
        # Password will be auto-generated by the signal
