...
urlpatterns = [
    ...
    path(
        "",
        views.ProgramFilterView.as_view(),
        name="programs",
    ),
    ...
    path(
        "course/<slug>/scorm/upload/",
        views.handle_scorm_upload,
        name="upload_scorm",
    ),

    path(
        "course/<slug>/scorm/<int:scorm_id>/launch/",
        views.launch_scorm,
        name="launch_scorm",
    ),
    ...
    # =====================================================
    # NEW: Video Progress API
    # Student watch-progress is saved here.
    # =====================================================

    path(
        "course/<slug>/video_tutorials/<video_slug>/progress/",
        views.save_video_progress,
