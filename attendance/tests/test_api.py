...
from attendance.models import Attendance, ScheduleItem
...
class ScheduleItemModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.course = Course.objects.create(
            title="Python Programming", code="CS101", credit=3, program=self.program
        )
...
class AttendanceModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.student = Student.objects.create(student=self.user, level="Bachelor")
    ...
    def test_attendance_creation(self):
        ...
        attendance = Attendance.objects.create(
            Student=self.student, shcedule=self.schedule, status=True
        )
...
class ScheduleItemAPITest(APITestCase):
    ...
    def setUp(self):
        ...
        self.lecturer = User.objects.create_user(
            username="lecturer", password="lecturer123", is_lecturer=True
        )

        self.student_user = User.objects.create_user(
            username="student", password="student123", is_student=True
        )
        self.student = Student.objects.create(
            student=self.student_user, level="Bachelor", group=self.group
        )
...
class AttendanceAPITest(APITestCase):
    ...
    def test_student_cannot_update_attendance(self):
        ...
        response = self.client.patch(
            f"/attendance/attendances/{self.attendance.id}/", data
        )
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
    ...
    def test_lecturer_can_update_attendance(self):
        ...
        CourseAllocation.objects.create(lecturer=self.lecturer, courses=self.course)
    ...
    def test_statistics_endpoint(self):
        ...
        Attendance.objects.create(
            Student=self.student, shcedule=self.schedule, status=False
        )
    ...
    def test_bulk_update_attendance(self):
        ...
        student2_user = User.objects.create_user(
            username="student2", password="student123", is_student=True
        )
        student2 = Student.objects.create(
            student=student2_user, level="Bachelor", group=self.group
        )
        ...
        response = self.client.post(
            "/attendance/attendances/bulk_update/", data, format="json"
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)
